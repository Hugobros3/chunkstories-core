...
public class SkyPass extends RenderPass {
	...
	public SkyPass(RenderPasses pipeline, String name, SkyRenderer skyRenderer) {
		...
		this.rbShaded = pipeline.getRenderingInterface().newTexture2D(TextureFormat.RGB_HDR, gameWindow.getWidth(),
				gameWindow.getHeight());
		this.rbZBuffer = pipeline.getRenderingInterface().newTexture2D(TextureFormat.DEPTH_RENDERBUFFER,
