...
class EntityGroundItem(definition: EntityDefinition, world: World) : Entity(definition, world) {
    ...
    private val traitContents: ItemOnGroundContents

    var itemPile: ItemPile?
        get() = traitContents.itemPile
        set(itemPile) {
            traitContents.itemPile = itemPile
    ...
    /*constructor(t: EntityDefinition, location: World) : super(t, location) {
        traitContents = ItemOnGroundContents(this)
        EntityGroundItemRenderer(this)
    }

    constructor(t: EntityDefinition, location: World, itemPile: ItemPile) : super(t, location) {
        traitContents = ItemOnGroundContents(this, itemPile)
        spawnTime = System.currentTimeMillis()
    }*/
    ...
    override fun tick() {
        ...
        if (world is WorldMaster) {
            ...
            val inWater = voxelIn is VoxelLiquid
