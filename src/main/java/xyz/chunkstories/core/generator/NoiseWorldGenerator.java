        ...
        for (int x = 0; x < 32; x++)
            for (int z = 0; z < 32; z++) {
                ...
                for (int y = 0; y < 32; y++) {
                    ...
                    float lerpedX_y0z0 = lerp(x, generated[wwx * (wwy * c + b) + a],
                            generated[wwx * (wwy * c + b) + a + 1], a, a + 1, 32 / wx);
                    float lerpedX_y1z0 = lerp(x, generated[wwx * (wwy * c + b + 1) + a],
                            generated[wwx * (wwy * c + b + 1) + a + 1], a, a + 1, 32 / wx);

                    float lerpedX_y0z1 = lerp(x, generated[wwx * (wwy * (c + 1) + b) + a],
                            generated[wwx * (wwy * (c + 1) + b) + a + 1], a, a + 1, 32 / wx);
                    float lerpedX_y1z1 = lerp(x, generated[wwx * (wwy * (c + 1) + b + 1) + a],
                            generated[wwx * (wwy * (c + 1) + b + 1) + a + 1], a, a + 1, 32 / wx);
