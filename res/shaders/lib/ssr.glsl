vec3 raytrace(sampler2D depthBuffer, sampler2D colorBuffer, vec3 fragpos, vec3 rvector);
...
vec3 raytrace(sampler2D depthBuffer, sampler2D colorBuffer, vec3 fragpos, vec3 rvector/*, float fresnel*/) {
