<<<<<<< Upstream, based on github.com/master
<<<<<<< Upstream, based on github.com/master
<<<<<<< Upstream, based on github.com/master
<<<<<<< Upstream, based on github.com/master
#version 330
...
vec4 getDebugShit(vec2 coords)
{
	...
	shit.a = 1.0;
	return shit;
>>>>>>> bd420ef Removed gamma correction on VL
=======
#version 330
uniform sampler2D shadedBuffer;
...
vec4 getDebugShit(vec2 coords)
{
	...
	shit.a = 1.0;
	return shit;
>>>>>>> e3afce5 Improved on volumetrics
}