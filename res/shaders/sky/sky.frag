...
void main()
{
    ...
    vec3 fogColor = getFogColor(world.time, 2000 * normalize(vec3(eyeDirection.x  + 1.0, 0.0, eyeDirection.z))).rgb;
    
    float belowHorizon = 0.0;//clamp(-300 * eyeDirection.y, 0.0, 1.0);
